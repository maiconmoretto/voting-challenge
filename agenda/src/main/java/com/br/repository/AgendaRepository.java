...
public interface AgendaRepository extends JpaRepository<Agenda, Integer>{
	...
	@Query(value = "SELECT * FROM agenda a WHERE a.sent_to_messager = false and a.agenda_closed = false and a.created_at + INTERVAL a.duration SECOND <= NOW()", nativeQuery = true)
